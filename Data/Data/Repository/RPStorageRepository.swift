...
public class RPStorageRepository: RPStorageRepositoryProtocol {
    
    private let dataSource: RPStorageDatasource
    
    public init() {
        self.dataSource = RPStorageDataSourceImplementation()
    }
